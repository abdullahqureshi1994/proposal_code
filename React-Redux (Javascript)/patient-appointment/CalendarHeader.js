...
class PatientAppointmentHeader extends Toolbar {
	viewButtons() {
	...
	render() {
		...
		return (
			<ThemeProvider theme={mainThemeDark}>
				<div className={clsx(classes.root, 'flex h-100 min-h-100 relative', moment(date).format('MMM'))}>
					<div className="flex flex-1 flex-col p-12 justify-between z-10 container">
						<div className="flex flex-col items-center justify-between sm:flex-row">
							<div className="flex items-center my-0 sm:mb-0">
...
export default connect(mapStateToProps)(withStyles(styles, { withTheme: true })(PatientAppointmentHeader));
